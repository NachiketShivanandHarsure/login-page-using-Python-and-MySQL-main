...
class SignUp:
    def __init__(self, root):
        ...
        frame = Frame(self.window, bg="orange")
        frame.place(x=350,y=100,width=500,height=550)

        title1 = Label(frame, text="Sign Up", font=("times new roman",25,"bold"),bg="orange").place(x=20, y=10)
        title2 = Label(frame, text="Join with us", font=("times new roman",13),bg="orange", fg="white").place(x=20, y=50)

        f_name = Label(frame, text="First name", font=("helvetica",15,"bold"),bg="orange").place(x=20, y=100)
        l_name = Label(frame, text="Last name", font=("helvetica",15,"bold"),bg="orange").place(x=240, y=100)
        ...
        email = Label(frame, text="Email", font=("helvetica",15,"bold"),bg="orange").place(x=20, y=180)

        self.email_txt = Entry(frame,font=("arial"))
        self.email_txt.place(x=20, y=210, width=420)

        sec_question = Label(frame, text="Security questions", font=("helvetica",15,"bold"),bg="orange").place(x=20, y=260)
        answer = Label(frame, text="Answer", font=("helvetica",15,"bold"),bg="orange").place(x=240, y=260)

        self.questions = ttk.Combobox(frame,font=("helvetica",13),state='readonly',justify=CENTER)
        self.questions['values'] = ("Select","What's your pet?","Your first teacher name","Your birthplace", "Your favorite food")
        ...
        password =  Label(frame, text="New password", font=("helvetica",15,"bold"),bg="orange").place(x=20, y=340)

        self.password_txt = Entry(frame,font=("arial"))
        self.password_txt.place(x=20, y=370, width=420)

        self.terms = IntVar()
        terms_and_con = Checkbutton(frame,text="I Agree The Terms & Conditions",variable=self.terms,onvalue=1,offvalue=0,bg="orange",font=("times new roman",12)).place(x=20,y=420)
